  ...
  return (
    <div className="bv1-form-screen">
      ...
      <section className="bv1-form-section">
        <h2 className="bv1-form-section-title">Quantitative metrics</h2>
      ...
      <section className="bv1-form-section">
        <h2 className="bv1-form-section-title">Sceptyczne pytania krytyka (qualitative)</h2>
        <p className="text-muted ci-section-hint">
      ...
      <section className="bv1-form-section">
        <h2 className="bv1-form-section-title">Następne kroki</h2>
        {overall === "green" && (
          <p>
        ...
        <p style={{ marginTop: 12 }}>
          <Link href="/v/bold-v1/eksport/tydzien" className="btn-edit">
...
export function BoldV1AuditW22Client(props: Props) {
  return (
