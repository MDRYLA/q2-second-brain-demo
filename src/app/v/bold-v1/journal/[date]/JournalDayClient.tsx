  ...
  return (
    <div className="bv1-form-screen">
      <div className="page-header">
        ...
        <Link href="/v/bold-v1/timeline" className="btn-edit">
      ...
      <div className="journal-nav">
        <Link href={`/v/bold-v1/journal/${dateOffset(date, -1)}` as Route} className="dash-card-link">
          ← Poprzedni dzień
        </Link>
        <Link href={`/v/bold-v1/journal/${dateOffset(date, 1)}` as Route} className="dash-card-link">
          Następny dzień →
      ...
      {ci && (
        <section className="bv1-form-section journal-section">
          <div className="journal-section-head">
            <h2 className="bv1-form-section-title">Check-in (rano)</h2>
      ...
      {co && (
        <section className="bv1-form-section journal-section">
          <div className="journal-section-head">
            <h2 className="bv1-form-section-title">Check-out (wieczór)</h2>
      ...
      {notes && (
        <section className="bv1-form-section journal-section">
          <div className="journal-section-head">
            <h2 className="bv1-form-section-title">Coś ważnego do zapamiętania</h2>
      ...
      {tickedKeys.length > 0 && (
        <section className="bv1-form-section journal-section">
          <h2 className="bv1-form-section-title">Quick-tick</h2>
      ...
      {trainingSessions.length > 0 && (
        <section className="bv1-form-section journal-section">
          <div className="journal-section-head">
            <h2 className="bv1-form-section-title">Siłownia</h2>
            <Link href="/v/bold-v1/silownia" className="dash-card-link" style={{ fontSize: 12 }}>
              Edytuj →
            </Link>
          </div>
...
export function BoldV1JournalDayClient(props: Props) {
  return (
