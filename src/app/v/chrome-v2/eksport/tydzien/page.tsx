...
import { ChromeV2EksportTydzienClient, type RawDay } from "./EksportTydzienClient";
...
export default async function ChromeV2EksportTydzienPage() {
  const ref = new Date();
