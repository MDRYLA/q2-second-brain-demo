...
export function ChromeV2JezykiClient(props: Props) {
  return (
  ...
  return (
    <div className="cv2-form-screen">
      ...
      <section className="cv2-form-section">
        ...
        {showAddLang && (
          <div className="cv2-form-section" style={{ marginTop: 12 }}>
            <h3 className="cv2-form-section-title">Nowy język</h3>
      ...
      {activeLang && (
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Nowe słowo — {activeLang.name}</h2>
