...
function CheckOutContent({
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      if (isEditingPast) {
        router.push(`/v/chrome-v2/journal/${entryDate}` as never);
      } else {
        router.push("/v/chrome-v2/dashboard?saved=checkout");
      }
    }, 1500);
    ...
    <div className="cv2-form-screen">
        ...
        subtitle={
          isEditingPast
            ...
            : isEditMode
              ...
              : "Wieczorny check-out — wszystko opcjonalne"
        }
      />
      ...
      <div className="ci-form">
        ...
        {(() => {
          ...
          return (
            <section className="cv2-form-section">
              <h2 className="cv2-form-section-title">Postęp tygodnia dzisiaj</h2>
        ...
        {week && todayPlanTasks.length > 0 && (
          <section className="cv2-form-section">
            <h2 className="cv2-form-section-title">Plan dnia</h2>
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Co jeszcze robiłem poza planem dnia</h2>
          <textarea
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Energia na koniec dnia</h2>
          <Likert4
            label=""
            name="energyEndWord"
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Nastrój dnia</h2>
          <Likert4
            label=""
            name="moodWord"
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Co dziś było ważne?</h2>
          <input
            type="text"
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Refleksja wieczorna</h2>
          <textarea
            className="ci-textarea"
            placeholder=""
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Zgodność z Konstytucją dziś</h2>
          <Likert4
            label=""
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Cień z Konstytucji złapany?</h2>
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Proaktywność dziś</h2>
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Czy czułem flow dzisiaj?</h2>
          <BoolToggle
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Wdrażałem nową wiedzę?</h2>
          <Likert4
            label=""
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Aktywność dnia</h2>
        ...
        {/* === SESJA 17: Drzemka === */}
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Drzemka</h2>
          <BoolToggle
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Czas przed ekranem dziś</h2>
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Jedzenie</h2>
...
export function ChromeV2CheckOutClient(props: Props) {
  return (
