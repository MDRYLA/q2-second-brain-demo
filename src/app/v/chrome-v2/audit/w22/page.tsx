...
import { ChromeV2AuditW22Client } from "./AuditW22Client";

interface PageProps {
  searchParams?: Promise<{ days?: string }>;
}

export default async function ChromeV2AuditW22Page({ searchParams }: PageProps) {
  ...
  return <ChromeV2AuditW22Client entries={entries} daysBack={daysBack} reviews={reviews} />;
}
