...
function DzienContent({
  ...
  return (
    <div className="cv2-form-screen dzien-page">
      <ChromeV2Hero
        eyebrow="Plan dnia"
        title={formatLabel(selDate)}
      />
      ...
      {!weekPlan && selDate === todayDate && (
        <div className="ci-banner" style={{ marginBottom: 16 }}>
          Brak planu tygodnia.{" "}
          <Link href="/v/chrome-v2/plan/tydzien" className="dash-card-link">
            Zaplanuj tydzień
          </Link>
        </div>
      )}
      ...
      {editingId && (
        ...
        <div className="dzien-edit-form">
          <h3 className="cv2-form-section-title">
      ...
      {(() => {
        ...
        return (
          <div className="cv2-form-section">
            <h2 className="cv2-form-section-title">Ostrzenie piły — do zaplanowania</h2>
...
export function ChromeV2DzienPlanClient(props: Props) {
  return (
