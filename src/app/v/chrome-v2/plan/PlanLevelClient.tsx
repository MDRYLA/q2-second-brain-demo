  ...
  return (
    <div className="cv2-form-screen">
      ...
      <div className="plan-form">
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">{copy.bulletsLabel}</h2>
        ...
        {(level === "kwartal" || level === "rok") && (
          <section className="cv2-form-section">
            <h2 className="cv2-form-section-title">Alokacja ról (%)</h2>
...
export function ChromeV2PlanLevelClient(props: Props) {
  return (
