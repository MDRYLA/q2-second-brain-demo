...
function TydzienContent({ periodStart, periodEnd, periodLabel, todayIdx, initialPlan, monthPlan, quarterPlan, yearPlan, prevWeekHref, nextWeekHref, isCurrentWeek }: Props) {
  ...
  return (
    <div className="cv2-form-screen">
      <ChromeV2Hero eyebrow={periodLabel} title="Plan tygodnia">
        {(prevWeekHref || nextWeekHref) && (
          <div style={{ display: "flex", gap: 8, alignItems: "center", marginTop: 16, flexWrap: "wrap" }}>
            ...
            {!isCurrentWeek && (
              <Link href="/v/chrome-v2/plan/tydzien" className="btn-edit" aria-label="Wróć do bieżącego tygodnia">
                Dziś
              </Link>
            )}
          </div>
      ...
      {hasInheritance && (
        <div className="kaskada-banner">
          ...
          <p className="kaskada-banner-hint">
            Tydzień powinien być spójny z wyższymi celami. Edytuj <a href="/v/chrome-v2/plan/rok" className="dash-card-link">rok</a>
            {" / "}<a href="/v/chrome-v2/plan/kwartal" className="dash-card-link">kwartał</a>
            {" / "}<a href="/v/chrome-v2/plan/miesiac" className="dash-card-link">miesiąc</a> jeśli się rozjeżdża.
          </p>
        </div>
      )}
      ...
      <div className="plan-form">
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Priorytety tygodnia (Q2 — ważne, niepilne)</h2>
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">
            <span className="tydzien-other-badge">poza Q2</span>
            Inne zadania tygodnia
          </h2>
          <ul className="plan-bullets">
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Ostrzenie piły — odnowa w 4 wymiarach</h2>
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Coś co na mnie źle wpływa i chcę to zmienić</h2>
        ...
        <section className="cv2-form-section">
          <h2 className="cv2-form-section-title">Zadania per dzień</h2>
...
export function ChromeV2TydzienPlanClient(props: Props) {
  return (
