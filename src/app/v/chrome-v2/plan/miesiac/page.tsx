...
export default async function ChromeV2MiesiacPage({ searchParams }: PageProps) {
  ...
  return (
    <ChromeV2PlanLevelClient
      ...
      prevHref={`/v/chrome-v2/plan/miesiac?date=${addMonths(start, -1)}`}
      nextHref={`/v/chrome-v2/plan/miesiac?date=${addMonths(start, 1)}`}
      todayHref="/v/chrome-v2/plan/miesiac"
